...
import { Bubbles, CoconutFruitCubes, IceCubes, ImageInfo, Leaf, LemonChips, PearlBalls, Slogan, Straw } from './items'
...
export class Tea {
  ...
  private backgroundColor = 0xE4E4E7
  ...
  watch() {
    ...
    watch(() => diyItems, () => {
      this.iceCubes.changeVisible(diyItems.includes('Ice'))
      this.pearlBalls.changeVisible(diyItems.includes('Pearl'))
      this.coconutFruitCubes.changeVisible(diyItems.includes('CoconutFruit'))
      this.lemonChips.changeVisible(diyItems.includes('Lemon'))
