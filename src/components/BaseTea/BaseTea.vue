...
.wrapper {
    ...
    .glass {
        ...
        .cube2 {
            ...
            // animation: floatIce2 2s infinite alternate;
        }
        .cube3 {
            top: 2%;
            width: 45px;
        ...
        .leaf {
            ...
            overflow: hidden;
            z-index: 10;
            animation: floatLeaf 5s ease-in alternate infinite;
            &:after {
                content: "";
                position: absolute;
                height: 120px;
